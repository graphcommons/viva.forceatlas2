;(function(undefined) {
  ...
  if (inWebWorker) {
    ...
    GraphCommons.ForceAtlas2.Worker = getWorkerFn;
    if (GraphCommons.ForceAtlas2.sigma !== 'undefined') {
      GraphCommons.ForceAtlas2.sigma.prototype.getForceAtlas2Worker = getWorkerFn;
    }
